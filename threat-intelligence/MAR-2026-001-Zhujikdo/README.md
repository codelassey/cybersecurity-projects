...
| **Full Analysis Report** | [ANY.RUN Task](https://any.run/report/bd33535523f6740b10793d23a5f26f329cbe9d5730473c9888b2c33b36797094/a0cd19c6-c7d4-4287-bbba-eb7acb40e846) |
...
### Attack Chain
![attack_chain](images/INVESTIGATION.drawio.png)

### Social Engineering
![social engineering](images/social.png)
...
![VirusTotal 2/72 result for Msimg32.dll](images/vt3.png)
...
![PEStudio import table showing MSIMG32.dll](images/die2.png)
...
![PEStudio flagged imports](images/pe2.png)
...
![Hex view of winhttp2 first 16 bytes](images/hex.png)
...
![ANY.RUN process tree showing matching behaviour](images/tree1.png)  
![ANY.RUN process tree showing matching behaviour](images/tree2.png)
...
![Process Explorer showing the process tree](images/tree3.png)
...
![The decoy PDF as displayed during execution](images/doc.png)
...
![Process Explorer showing calc.exe network connections to 15.235.172.37](images/beac2.png)  
![Process Monitor showing calc.exe network connections to 15.235.172.37](images/beac3.png)
...
![Wireshark capture showing TLS Client Hello followed by Fatal Alert pattern](images/beac1.png)
...
![ANY.RUN network connections panel](images/beac4.png)
...
Reputation (AbuseIPDB): On 13th March, 2026, a lookup for `15.235.172.37` returned “not found in our database” This indicates the IP has not been previously reported to AbuseIPDB at the time of checking. This result does not reduce confidence in the IP’s malicious role, as command-and-control behavior was directly observed during execution in my sandbox environment and corroborated by ANY.RUN network artifacts. The IP should still be treated as a confirmed C2 indicator hence, I submitted a report privilage request to AbuseIPDB and awaiting respone. I will update this report accordingly.

Update (AbuseIPDB): Today, 16th March 2026, I received an email from AbuseIPDB stating my report privilage request has been approved. So next, I went straight forward to reporting. Even though the C2 server was hosted on OVHcloud, reporting to AbuseIPDB will still help track malicious activity from cloud hosts.
...
| Discovery | System Information Gathering | T1082 |
...
| Command and Control | Non-Standard Port | T1571 |
  ...
  - **T1012**     : Reads Microsoft office registry keys
  - **T1082**     : Reads the machine GUID from the registry 
...
![MITRE ATT&CK Navigator layer with observed techniques highlighted](images/layer1.svg)
...
![The Google Forms page](images/forms.png)

Figure 2  - Fakenet
![Starting up fakenet](images/fakenet.png)

Figure 3  - pythonw.exe Properties
![properties](images/pythonw.png)

Figure 4  - Process Explorer when exe is clicked
![process_explorer](images/proexx.png)

Figure 5  - Any.run analysis
![INSERT SCREENSHOT](images/anyrunn.png)

Figure 6 - Any.run MITRE ATT&CK Matrix
![SCREENSHOT](images/anayrunatt.png)

Figure 7 - AbuseIPDB Lookup 
![screenshot_of_abauseipdv_lookup](images/abuse.png)

Figuure 8 - AbuseIPDB Report Privilage Request
![report_privilage](images/abuse1.png)

Figure 9 - AbuseIPDB IP reeport after privilage request granted
![report_privilage](images/abuuse.png)
![report_privilage](images/abuuse1.png)
